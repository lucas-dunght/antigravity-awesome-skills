<!-- registry-sync: version=11.9.0; skills=1492; stars=39167; updated_at=2026-05-30T09:57:47+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,492+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,492+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,492+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,492+ Skills](#browse-1492-skills)
...
If you want a faster answer than "browse all 1,492+ skills", start with a tool-specific guide:
